    ...
    def init(self):
        ...
        self.modules = [
            ui.box((6, 0), (7, 40), [
                ...
                ui.str((2, 30), LEVEL, L_IN, format=state.db, color=curses.A_REVERSE),
                ui.str((3, 30), LEVEL, L_HIGH, format=state.db),
                ui.str((4, 30), LEVEL, L_MID, format=state.db),
                ui.str((5, 30), LEVEL, L_LOW, format=state.db),
            ...
            ui.box((6, 40), (7, 40), [
                ...
                ui.str((2, 30), LEVEL, R_IN, format=state.db),
                ui.str((3, 30), LEVEL, R_HIGH, format=state.db),
                ui.str((4, 30), LEVEL, R_MID, format=state.db),
                ui.str((5, 30), LEVEL, R_LOW, format=state.db),
                ui.str((1, 35), LABEL, "C"),
            ...
            ui.box((13, 0), (9, 40), [
                ...
                ui.str((2, 30), LEVEL, SS_LEVEL, format=state.db),
                ui.str((3, 30), LEVEL, SS_UPPER, format=state.db),
                ui.str((4, 30), LEVEL, SS_LOWER, format=state.db),
    ...
    def init(self):
        ...
        self.modules = [
            ...
            ui.box((13, 0), (9, 80), [
                ...
                ui.str((4, 2), (1, 6), "Q"),
                ui.str((5, 2), (1, 6), "Type"),
                ui.str((1, 2), (1, 8), "Band 1"),
                ui.edit((2, 8), (1, 8), PEQ_MID_B1_FREQ, format=state.hz),
                ui.edit((3, 8), (1, 8), PEQ_MID_B1_GAIN, format=state.db),
                ui.edit((4, 8), (1, 8), PEQ_MID_B1_Q),
                ui.str((5, 8), (1, 8), PEQ_MID_B1_TYPE),
            ]),
        ]
def main(stdscr):
    dims = (80, 30)
